...
const Ads = ({handleClick}) => {
  return (
    <div className="w-full flex justify-center items-center gradient_bg  h-auto py-10">
      <div className="w-[90%] lg:w-[70%] mx-auto flex flex-col justify-center items-start space-y-3">
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start lg:gap-8 lg:mb-2">
